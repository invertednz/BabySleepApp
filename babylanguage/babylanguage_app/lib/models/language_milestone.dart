class LanguageMilestone {
  ...
  final List<LanguageActivity> activities;
  ...
  factory LanguageMilestone.fromJson(Map<String, dynamic> json) {
    return LanguageMilestone(
      ...
      activities: (json['activities'] as List<dynamic>?)
              ?.map((a) => LanguageActivity.fromJson(a as Map<String, dynamic>))
              .toList() ??
          [],
...
class LanguageActivity {
  ...
  factory LanguageActivity.fromJson(Map<String, dynamic> json) {
